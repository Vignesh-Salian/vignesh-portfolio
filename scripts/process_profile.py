...
# 3. Crop portrait with balanced, prominent framing
# Hair top is around y=90, chin is y=410, shoulders y=650
# Take a clean square box that captures head to mid-chest prominently
box_w = int(w * 0.88)
center_x = int(w * 0.53)
center_y = int(h * 0.34)
...
# Scale to 740x740 on 800x800 canvas so face is big, prominent & centered with 35px headroom!
target_w = 740
target_h = 740
...
glow_draw.ellipse((80, 60, 720, 700), fill=(0, 240, 255, 35))
glow_draw.ellipse((140, 100, 660, 640), fill=(138, 43, 226, 50))
glow_draw.ellipse((200, 140, 600, 580), fill=(255, 0, 127, 30))
glow_draw.ellipse((260, 180, 540, 520), fill=(0, 255, 163, 20))
...
print("SUCCESS: Perfectly framed and sized profile_original.png saved at", out_path)
