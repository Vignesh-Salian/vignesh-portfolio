        ...
        {isFullscreenPhoto && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative max-w-[90vw] max-h-[85vh] sm:max-w-[480px] sm:max-h-[480px] xl:max-w-[520px] xl:max-h-[520px] w-full aspect-square flex flex-col items-center justify-center cursor-pointer"
              onClick={(e) => {
                e.stopPropagation();
                setIsFullscreenPhoto(false);
              }}
          ...
          >
            ...
            <div className="relative w-full h-[36px] xl:h-[38px] px-3 rounded-[10px] bg-[#070c18] flex items-center justify-between transition-all group-hover:bg-[#070c18]/80">
              ...
              <div className="flex items-center gap-1">
                <Send className="w-3 h-3 text-[#ff007f] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </div>
            </div>
          </motion.button>
